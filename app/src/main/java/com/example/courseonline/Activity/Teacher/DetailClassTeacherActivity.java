...
public class DetailClassTeacherActivity extends AppCompatActivity {
...
//    private ImageView imgState2, imgState3;
    ...
    private TextView txtNone7, txtDetailNameP1, txtDetailTimeP2, txtDetailDescriptionP1, txtDetailTimeP1;
    private String key_id;
    private static final String KEY_COURSE_STATE = "course_state";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_class_teacher);
        mapping();
...
//                    });
//                }else{
//                    Toast.makeText(DetailClassTeacherActivity.this, "Nội dung khoá học chưa đầy đủ", Toast.LENGTH_SHORT).show();
...
//                if(state1 != false)
//                {
//                    Toast.makeText(DetailClassTeacherActivity.this, "Hãy chuyển khoá học sang chế độ riêng tư để chỉnh sửa", Toast.LENGTH_SHORT).show();
//                }else{
//                    Intent intent = new Intent(DetailClassTeacherActivity.this, UploadStep1Activity.class);
...
//                    Toast.makeText(DetailClassTeacherActivity.this, "Hãy chuyển khoá học sang chế độ riêng tư để chỉnh sửa", Toast.LENGTH_SHORT).show();
//                }else{
//                    Intent intent = new Intent(DetailClassTeacherActivity.this, UploadTypeActivity.class);
//                    intent.putExtra("key_id", key_id);
//                    startActivity(intent);
//                    overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);}
//            }
...
//                    Toast.makeText(DetailClassTeacherActivity.this, "Hãy chuyển khoá học sang chế độ riêng tư để chỉnh sửa", Toast.LENGTH_SHORT).show();
//                }else{
//                    Intent intent = new Intent(DetailClassTeacherActivity.this, UploadStep2Activity.class);
//                    intent.putExtra("key_id", key_id);
//                    startActivity(intent);
//                    overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
//                }
...
//        });
    ...
    private void loadData(){
        recyclerP2.setLayoutManager(new LinearLayoutManager(DetailClassTeacherActivity.this,LinearLayoutManager.HORIZONTAL,false));
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                if(value.size() != 0)
                {
                    ...
                    for(QueryDocumentSnapshot doc : value)
                    {
                        ...
                        TreeNode parent = new TreeNode(nodeParent).setViewHolder(new MyHolder(DetailClassTeacherActivity.this));
                        MyHolder.IconTreeItem nodeChild1 = new MyHolder.IconTreeItem();
                        MyHolder.IconTreeItem nodeChild2 = new MyHolder.IconTreeItem();
                        nodeChild1.icon = 1;
                        nodeChild2.icon = 1;
                        TreeNode child1 = new TreeNode(nodeChild1).setViewHolder(new MyHolder(DetailClassTeacherActivity.this));
                        TreeNode child2 = new TreeNode(nodeChild2).setViewHolder(new MyHolder(DetailClassTeacherActivity.this));
...
//                                    imgState3.setImageDrawable(getResources().getDrawable(R.drawable.ready, null));
                                    ...
                                    for (QueryDocumentSnapshot doc : value)
                                    {
                                        ...
                                        TreeNode child11 = new TreeNode(nodeChild11).setViewHolder(new MyHolder(DetailClassTeacherActivity.this));
...
//                                    imgState3.setImageDrawable(getResources().getDrawable(R.drawable.notready,null));
                            ...
                            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                                ...
                                if(value.size() != 0)
                                {
                                    ...
                                    for (QueryDocumentSnapshot doc : value)
                                    {
                                        ...
                                        TreeNode child12 = new TreeNode(nodeChild12).setViewHolder(new MyHolder(DetailClassTeacherActivity.this));
                    ...
                    AndroidTreeView tView = new AndroidTreeView(DetailClassTeacherActivity.this, root);
    ...
    private void mapping(){
        txtDetailNameP1 = (TextView) findViewById(R.id.txtDetailNameP1C);
//        txtPriceNameP1 = (TextView) findViewById(R.id.txtDetailPriceP1);
        txtDetailDescriptionP1 = (TextView) findViewById(R.id.txtDetailDescriptionP1C);
//        txtDetailTimeP1 = (TextView) findViewById(R.id.txtDetailTimeP1C);
//        txtDetailTimeP2 = (TextView) findViewById(R.id.txtDetailTimeP2C);
//        txtDetailMember = (TextView) findViewById(R.id.txtDetailMember);
        txtNone7 = (TextView) findViewById(R.id.txtNone7C);
...
//        btnDetailEditP3 = (TextView) findViewById(R.id.btnDetailEditP3);
        imgDetail = (ShapeableImageView) findViewById(R.id.imgDetailC);
        imgBack = (ShapeableImageView) findViewById(R.id.backActionDetailC);
        linearContent = (FrameLayout) findViewById(R.id.linearP3C);
//        imgState3 = (ImageView) findViewById(R.id.imgState3);
//        imgState2 = (ImageView) findViewById(R.id.imgState2);
        recyclerP2 = (RecyclerView) findViewById(R.id.recyclerP2C);
